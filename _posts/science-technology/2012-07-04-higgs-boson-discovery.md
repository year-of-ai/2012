...
- physics
- discoveries
excerpt: 'The existence of the Higgs boson was independently predicted in **1964** by six physicists working in three separate groups: Robert Brout and François Englert; Peter Higgs; and Gerald Guralnik, Carl Hagen, and Tom Kibble. Their papers, published within months of each other in *Physical Review…'
preview: "/images/previews/science-technology.svg"
permalink: "/news/science-technology/higgs-boson-discovery/"
featured: true
---
...
- [Curiosity Rover Mars Landing]({{ '/news/science-technology/curiosity-rover-mars-landing/' | relative_url }}) — the other landmark science milestone of summer 2012
- [European Debt Crisis — 2012 Escalation]({{ '/news/society-economics/european-debt-crisis-2012/' | relative_url }}) — the broader economic backdrop of 2012
- [Syrian Civil War — 2012 Escalation]({{ '/news/history-politics/syrian-civil-war-escalation-2012/' | relative_url }}) — a defining geopolitical event of the same year
- [Windows 8 Release]({{ '/news/science-technology/windows-8-release/' | relative_url }}) — a major technology milestone of 2012 from a very different domain
...
- [CMS experiment — Wikipedia](https://en.wikipedia.org/wiki/CMS_experiment)
- [Nobel Prize in Physics 2013 — NobelPrize.org](https://www.nobelprize.org/prizes/physics/2013/summary/)
- [CERN Press Release, 4 July 2012](https://home.cern/news/press-release/cern/cern-experiments-observe-particle-consistent-long-sought-higgs-boson)
