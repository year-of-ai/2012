...
- space
- discoveries
excerpt: On **August 6, 2012**, NASA's Curiosity rover successfully landed on Mars after an eight-month journey spanning **560 million kilometres** from Earth. The rover, part of the Mars Science Laboratory (MSL) mission, touched down in **Gale Crater** at a site subsequently named **Bradbury…
preview: "/images/previews/science-technology.svg"
permalink: "/news/science-technology/curiosity-rover-mars-landing/"
---
...
1. **Atmospheric entry**: The spacecraft entered the Martian atmosphere at approximately **5.9 km/s** (21,240 km/h). A heat shield—at **4.5 metres in diameter**, the largest deployed in deep space at that time—absorbed temperatures reaching roughly **2,100°C**.
2. **Supersonic parachute deployment**: At approximately Mach 1.7, a 21.5-metre-diameter parachute deployed, slowing descent to roughly 100 m/s.
3. **Powered descent stage**: After the heat shield was jettisoned, a rocket-powered "sky crane" descent stage fired **eight hydrazine rocket motors** to slow the vehicle to near-hover above the surface.
4. **Sky crane manoeuvre**: Nylon cables lowered Curiosity from the descent stage at approximately **0.75 m/s** until its six wheels touched down. The descent stage then flew away to crash at a safe distance.
...
- [2012 London Summer Olympics]({{ '/news/history-politics/london-2012-olympics/' | relative_url }}) — the Games closed just weeks before Curiosity's landing, in the same eventful summer of 2012
- [2012 United States Presidential Election]({{ '/news/history-politics/2012-us-presidential-election/' | relative_url }}) — Curiosity's discoveries were an early-term backdrop to Obama's second administration
- [Higgs Boson Discovery]({{ '/news/science-technology/higgs-boson-discovery/' | relative_url }}) — the other landmark science milestone of summer 2012
- [Windows 8 Release]({{ '/news/science-technology/windows-8-release/' | relative_url }}) — the year's other major technology event, Microsoft's most significant operating-system redesign in nearly two decades
...
- [Curiosity (rover) - Wikipedia](https://en.wikipedia.org/wiki/Curiosity_(rover))
- [Curiosity rover lands on Mars — Science Learning Hub](https://www.sciencelearn.org.nz/resources/2430-curiosity-rover-lands-on-mars)
- [Car-size rover Curiosity lands on Mars - ScienceDaily](https://www.sciencedaily.com/releases/2012/08/120806014143.htm)
- [How NASA's Curiosity rover changed Mars landings forever - Space.com](https://www.space.com/curiosity-rover-sky-crane-landing-mars-exploration)
- [Organic molecules found on Mars — Science, 2018](https://science.sciencemag.org/content/360/6393/1096)
- [Seasonal variations in Martian methane — Nature Geoscience, 2019](https://www.nature.com/articles/s41561-019-0352-x)
